...
import com.squareup.picasso.Picasso;
    ...
    public class ClassementomportementList extends ArrayAdapter<String> {
        private String[] idEt;
        ...
        public ClassementomportementList(Activity context, String[] idEt, String [] NomEt, String[] photo_util, String[] score, String[] rang){
        ...
        public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            View r = convertView;
            ClassementomportementList.ViewHolder viewHolder = null;


            if(r==null){
                LayoutInflater layoutInflater = context.getLayoutInflater();
                r = layoutInflater.inflate(R.layout.classement_prof,null,false);
                viewHolder = new ClassementomportementList.ViewHolder(r);
                r.setTag(viewHolder);

            }else{
                viewHolder =(ClassementomportementList.ViewHolder) r.getTag();
            }
