...
public class VoteServ extends AsyncTask<String,Void,String> {
    Context context;
    AlertDialog alertDialog;
    public VoteServ(Context ctx) {
        context = ctx;
    }
    private String type;
    ...
    protected void onPostExecute(String result) {
        ...
        try
        {
            ...
            for(int i=0;i<ja.length();i++)
            {
                ...
                VoteContent voteContent = new VoteContent(context);
                ...
                Vote vote = new Vote(
                        Integer.parseInt(jo.getString("idVote")),
                        jo.getString("libVote"),
                        jo.getString("DateDebut"),
                        jo.getString("DateFin"),
                        jo.getString("etatVote"),
                        jo.getString("anonymat")
                );
