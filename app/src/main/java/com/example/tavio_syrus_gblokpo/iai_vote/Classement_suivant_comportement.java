...
public class Classement_suivant_comportement extends AppCompatActivity {
    private ListView listprof;
    private String[] NomEt;
    private String[] idEt;
    private String[] photo_util_p,score,rang;
    private SearchView rech;
    ClassementomportementList classementomportementList;
    private CircleImageView imageView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_classement_suivant_comportement);
        listprof = (ListView) findViewById(R.id.Profil_Liste_View);
        initData();
        classementomportementList = new ClassementomportementList(this, idEt, NomEt, photo_util_p,score,rang);
        listprof.setAdapter(classementomportementList);
        ...
        rech.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                classementomportementList = new ClassementomportementList((Activity) getApplicationContext(), idEt, NomEt, photo_util_p,score,rang);
                listprof.setAdapter(classementomportementList);
                return true;
            }
        });
