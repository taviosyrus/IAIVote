    ...
    */
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            childViewHolder.radioButton1 = (RadioButton) convertView
                     .findViewById(R.id.radiobutton1);
            childViewHolder.radioButton2 = (RadioButton) convertView
                    .findViewById(R.id.radiobutton2);


            childViewHolder.radioGroup = (RadioGroup) convertView
		...
		childViewHolder.radioButton1.setOnCheckedChangeListener(null);

        childViewHolder.radioButton2.setOnCheckedChangeListener(null);

        if (mChildCheckStates.containsKey(mGroupPosition)) {

            boolean getChecked[] = mChildCheckStates.get(mGroupPosition);

            childViewHolder.radioButton1.setChecked(getChecked[mChildPosition]);
            ...
            childViewHolder.radioButton1.setChecked(false);
        ...
        /**/
        childViewHolder.radioButton1.setOnCheckedChangeListener(new OnCheckedChangeListener() {
        ...
        childViewHolder.radioButton2.setOnCheckedChangeListener(new OnCheckedChangeListener() {
