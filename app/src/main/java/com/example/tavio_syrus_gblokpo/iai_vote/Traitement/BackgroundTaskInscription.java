...
public class BackgroundTaskInscription extends AsyncTask<String,Void,Boolean> {
    ...
    protected Boolean doInBackground(String... params) {
        ...
        String con_url = "http://192.168.43.191:82/ProjetDizewe/login.php";
        ...
        if(method.equals("connection")) {
            ...
            try {
                ...
                String donnee =
                        URLEncoder.encode("NOM_UTILISATEUR", "UTF-8") + "=" + URLEncoder.encode(user_name, "UTF-8") + "&" +
                        URLEncoder.encode("PASSWORD_UTILISATEUR", "UTF-8") + "=" + URLEncoder.encode(pass_word, "UTF-8") + "&" +
                        URLEncoder.encode("MATRICULE", "UTF-8") + "=" + URLEncoder.encode(matricule, "UTF-8");
