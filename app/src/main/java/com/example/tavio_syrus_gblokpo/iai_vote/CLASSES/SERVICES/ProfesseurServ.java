...
public class ProfesseurServ extends AsyncTask<String,Void,String> {
    Context context;
    AlertDialog alertDialog;
    public ProfesseurServ(Context ctx) {
        context = ctx;
    }
    private String type;
    ...
    protected void onPostExecute(String result) {
        ...
        try
        {
            ...
            for(int i=0;i<ja.length();i++)
            {
                ...
                ProfesseurContent professeurContent = new ProfesseurContent(context);



                ProfesseurDAO professeurDAO = new ProfesseurDAO(context);
                professeurContent.open();

                Professeur professeur = new Professeur(
                        Integer.parseInt(jo.getString("idPr")),
                        jo.getString("NomPr"),
                        jo.getString("PrenomPr"),
                        jo.getString("TelephonePr")
                );
