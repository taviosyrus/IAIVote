...
public class BackgroundTaskConnection extends AsyncTask<String,Void,Boolean> {
    ...
    public BackgroundTaskConnection(Context context){
    ...
    protected Boolean doInBackground(String... params) {
        ...
        String con_url = "http://192.168.43.12:82/ProjetDizewe/login.php";
